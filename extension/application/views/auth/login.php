...
<img class="mb-4" src="<?php echo base_url()?>public/bootstrap-4.3.1/logo_uncaus.png" alt="" width="72" height="72">
    ...
    <input style="text-align: center;" type="email" name="email" class="form-control" placeholder="Correo electrónico">
    <?php echo form_error('email');?>
    <input style="text-align: center;" type="password" name="password" class="form-control" placeholder="Contraseña">
